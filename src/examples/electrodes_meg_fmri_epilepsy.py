...
from src.preproc import meg, eeg, electrodes
...
def analyze_electrodes(subject):
    ...
    electrodes.join_groups_and_create_electrodes_labels(subject, snap=False)
...
def analyze_meg(subject, seizure_time, seizure_len):
    ...
    args = meg.read_cmd_args(dict(
        subject=subject,
        function='make_forward_solution,calc_inverse_operator,calc_stc,calc_labels_avg_per_condition',
...
if __name__ == '__main__':
    ...
    analyze_meg(subject, seizure_time, 5)
    # analyze_electrodes(subject)